...
const columns = [
  { data: 'id', title: 'ID', visible: false},
  {
    ...
    render: function(data: any, type: any) {
      ...
      if(data != null && data != '') {
        if(type === 'display') {
          imageHtml =  '<div class="image-list"><img src="'+import.meta.env.VITE_API_BASE_URL+'/storage/' +  data + '" alt="Image" /></div>';
        }
      }
      return imageHtml
    }
